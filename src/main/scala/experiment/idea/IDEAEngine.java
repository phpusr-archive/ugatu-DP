    ...
    implements BlockCipher
{
        ...
        int     outOff)
    {
        ...
        for (int round = 0; round < 8; round++)
        {
            ...
            //System.out.println(round+1 + ": s1: " + x0);

            x1 += workingKey[keyOff++];
            x1 &= MASK;
            //System.out.println(round+1 + ": s2: " + x1);

            x2 += workingKey[keyOff++];
            x2 &= MASK;
            //System.out.println(round+1 + ": s3: " + x2);

            x3 = mul(x3, workingKey[keyOff++]);
            //System.out.println(round+1 + ": s4: " + x3);

            t0 = x1;
            t1 = x2;
            x2 ^= x0;
            //System.out.println(round+1 + ": s5: " + x2);
            x1 ^= x3;
            //System.out.println(round+1 + ": s6: " + x1);

            x2 = mul(x2, workingKey[keyOff++]);
            System.out.println(round+1 + ": s7: " + x2);
            x1 += x2;
            x1 &= MASK;
            //System.out.println(round+1 + ": s8: " + x1);
            ...
            System.out.println(round + ": " + toHex(x0) + "," + toHex(x1) + "," + toHex(x2) + "," + toHex(x3));
        }
